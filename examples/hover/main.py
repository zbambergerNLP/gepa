...
def run_program(
    ...
    """Run a candidate and return generated query text plus retrieved pages.
    ...
    Returns:
        Intermediate query text when present and every passage retrieved by the
        selected execution path, in hop order.
    """
    if program == "1stage":
