"""Analyze action-choice diversity and proposal diversity across PUPA runs.
...
Usage:
    uv run python examples/pupa/analyze_actions.py outputs/della_rev2 [--tau 0.10]
...
def main():
    parser = argparse.ArgumentParser(description="Analyze PUPA action/proposal diversity")
