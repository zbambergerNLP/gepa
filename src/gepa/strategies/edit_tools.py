...
The minimal basis exposes ``INSERT_TEXT`` and ``DELETE_TEXT``. The broad basis
also exposes ``REPLACE_TEXT`` and ``MOVE_TEXT``; both decompose to the minimal
basis for logging. :data:`EDIT_TOOL_SETS` selects the basis.

The operator choices follow the cited editing literature:
