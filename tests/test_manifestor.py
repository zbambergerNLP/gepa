...
@pytest.mark.parametrize(
    "model",
    [
        pytest.param("openai/gpt-5", id="openai_prefix"),
        ...
        pytest.param("deepseek/deepseek-v4-flash", id="user_role_fallback"),
        pytest.param(None, id="custom_callable_fallback"),
    ],
)
def test_manifestor_always_uses_a_user_message(model: str | None) -> None:
