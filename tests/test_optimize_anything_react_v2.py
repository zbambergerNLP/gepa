...
def test_reflection_config_builds_react_v2_like_optimize(monkeypatch: pytest.MonkeyPatch) -> None:
        ...
        optimize_anything(
            ...
            config=GEPAConfig(
                ...
                reflection=ReflectionConfig(
                    ...
                    component_kinds={"system_prompt": "prompt"},
                    template_family="auto",
                    template_model="openai/gpt-5.6",
                ),
            ),
        )
    ...
    assert captured["component_kinds"] == {"system_prompt": "prompt"}
    assert captured["template_family"] == "openai-gpt-5.6"
        ...
        optimize_anything(
            ...
            config=GEPAConfig(
                ...
                reflection=ReflectionConfig(
                    ...
                    reflection_level=2,
                    template_family="openai-gpt-5.6",
                ),
            ),
        )
