"""Focused tests for Wikipedia-backed HotpotQA and HoVer harnesses."""
...
def test_wikipedia_della_docs_use_react_comparison_labels() -> None:
    for benchmark in ("hotpotqa", "hover"):
        readme = (REPO_ROOT / "examples" / benchmark / "README.md").read_text()
        assert "CONDITION=action" not in readme
        assert "CONDITION=both" in readme
