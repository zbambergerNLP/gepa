...
@pytest.mark.parametrize("dump_candidates", [dump_hotpotqa_candidates])
def test_candidate_artifacts_embed_run_contract(tmp_path: Path, dump_candidates) -> None:
    """Embed the exact run contract in HotPotQA candidate artifacts.
...
def test_stateless_action_menu_contract_records_hotpotqa_schema() -> None:
    """Persist the stateless action-menu contract for HotPotQA."""
